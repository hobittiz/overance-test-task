  ...
  <div class="container mx-auto min-h-screen flex-col items-center flex py-12">
    ...
    <form class="w-1/2" @submit.prevent>
      <div class="flex-col flex gap-3">
        ...
        />
        <div 
          class="input flex gap-2 items-center"
        ...
        >
          ...
          <input 
            ...
            :class="{ 
              '!border-green-400 shadow shadow-green-500/50 active': searchText && field.value.includes(searchText),
          ...
          >
            <svg class="w-2/4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30"><path d="M7 4a.995.995 0 0 0-.707.293l-2 2a.999.999 0 0 0 0 1.414L11.586 15l-7.293 7.293a.999.999 0 0 0 0 1.414l2 2a.999.999 0 0 0 1.414 0L15 18.414l7.293 7.293a.999.999 0 0 0 1.414 0l2-2a.999.999 0 0 0 0-1.414L18.414 15l7.293-7.293a.999.999 0 0 0 0-1.414l-2-2a.999.999 0 0 0-1.414 0L15 11.586 7.707 4.293A.996.996 0 0 0 7 4z"/></svg>
          </button>
        </div>
        <button
          type="button"
